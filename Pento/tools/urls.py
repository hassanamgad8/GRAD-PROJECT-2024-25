...
urlpatterns = [
    ...
    path('progress/<int:scan_id>/', views.progress_page, name='progress_page'),  # Corrected name to match `progress_page`
    path('scan_progress/<int:scan_id>/', views.scan_progress, name='scan_progress'),
    path('results/<int:scan_id>/', views.results_page, name='scan_results'),
